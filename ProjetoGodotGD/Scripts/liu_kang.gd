...
func _on_animated_sprite_2d_animation_finished():
	...
	if $AnimatedSprite2D.animation == "skill1" or $AnimatedSprite2D.animation == "jumpSkill" or $AnimatedSprite2D.animation == "punch" or  $AnimatedSprite2D.animation == "kick" or $AnimatedSprite2D.animation == "bikeKick":
		is_Attacking = false
